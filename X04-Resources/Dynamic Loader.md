...
We use the head command to have a shorter output. The -l option of readelf lists the 
...
The execution start address for the program is also [set to be the entry 
